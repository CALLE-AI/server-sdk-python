...
from ..models.call_task_object import CallTaskObject
from ..models.call_task_object import check_call_task_object
from typing import cast
import datetime

if TYPE_CHECKING:
    from ..models.call_task_metadata import CallTaskMetadata
    from ..models.call_task_recipient import CallTaskRecipient
    from ..models.call_task_structured_result_type_0 import (
        CallTaskStructuredResultType0,
    )
    from ..models.completion_confidence import CompletionConfidence


T = TypeVar("T", bound="CallTask")
...
class CallTask:
    ...
    Attributes:
        ...
        object_ (CallTaskObject): Always `call_task` for call task responses.
        ...
        structured_result (CallTaskStructuredResultType0 | None): Schema-valid structured result object extracted for
            the whole call task using `result_schema`.
        ...
        evidence (list[str]): Short evidence items supporting the post-summary task outcome. Empty until CALL-E has
            terminal evidence.
        metadata (CallTaskMetadata): Caller-owned metadata submitted on the create call request.
    ...
    id: str
    object_: CallTaskObject
    status: CallStatus
    task: str
    recipients: list[CallTaskRecipient]
    structured_result: CallTaskStructuredResultType0 | None
    summary: None | str
    task_completed: bool | None
    completion_confidence: CompletionConfidence | None
    evidence: list[str]
    metadata: CallTaskMetadata
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.structured_result, CallTaskStructuredResultType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        object_ = check_call_task_object(d.pop("object"))
        ...
        def _parse_structured_result(
            data: object,
        ) -> CallTaskStructuredResultType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                structured_result_type_0 = CallTaskStructuredResultType0.from_dict(data)

                return structured_result_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(CallTaskStructuredResultType0 | None, data)
        ...
        metadata = CallTaskMetadata.from_dict(d.pop("metadata"))
