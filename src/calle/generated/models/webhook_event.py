...
from ..models.webhook_event_type import check_webhook_event_type
...
class WebhookEvent:
    ...
    Attributes:
        id (str): Unique webhook event id. Use it as an idempotency key when processing webhook side effects.
        type_ (WebhookEventType): Terminal webhook event type.
        created_at (datetime.datetime): ISO 8601 timestamp when CALL-E created this webhook event.
