...
T = TypeVar("T", bound="CreateCallRequestMetadata")
...
class CreateCallRequestMetadata:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        create_call_request_metadata = cls()

        create_call_request_metadata.additional_properties = d
        return create_call_request_metadata
